...
export default function StepParcelDetails() {
  ...
  const total =
    charge != null
      ? bookingTotal({ ...booking, deliveryCharge: charge })
      : null;
    ...
    <div className="step-card">
          ...
          {outOfRange ? (
            ...
            <>
              ...
              <div className="summary__row">
                ...
                <span className="amount">{formatRupees(booking.quantity * price)}</span>
              </div>
              <div className="summary__row">
                <span>Delivery charge</span>
                <span className="amount">{deliverySlabLabel(booking.distanceKm)} - {formatRupees(charge)}</span>
              </div>
      ...
      <button
        ...
        disabled={
          outOfRange ||
          total == null ||
          booking.distanceKm == null || booking.postcode
        }
      >
        Continue
      </button>
